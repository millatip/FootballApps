...
class NextMatchAdapter(private val matches: List<Match>, val listener: (Match) -> Unit, val notificationListener: (Match) -> Unit) : RecyclerView.Adapter<NextMatchAdapter.ViewHolder>(){
